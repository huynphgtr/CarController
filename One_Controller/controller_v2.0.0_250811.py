...
class Controller:
    ...
    async def run(self): 
        ...
        if not self.car_planner2.fetch_map_data():
            print("Failed to fetch map 2 data.")
        try:
        ...
        try:   
            # self.car_planner2.pre_visited = set()
        ...
        try:  
            self.car_planner2.pre_visited = set(path1)
            # print(self.car_planner2.pre_visited)
        ...
        #extract direction of 2 car
        direction = self.car_planner1.extract_direction(map_url=TARGET_URL,agv_paths=agv_paths1)
        direction2 = self.car_planner2.extract_direction(map_url=TARGET_URL,agv_paths=agv_paths2)
        self.car_planner1.direction = direction['AGV1']
        self.car_planner2.direction = direction2['AGV1']
