...
class Controller:
    ...
    def find_point_pairs(self):
        ...
        # controller.get_path_direction([dest0], start0, dest1)
        # path3 = controller.path
        # print("Path 3: ", path3)

        # controller.get_path_direction([dest1], start1, dest0)
        # path4 = controller.path
        # print("Path 4: ", path4)
