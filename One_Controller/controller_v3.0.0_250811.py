...
class CarController: 
    ...
    def get_path_direction(self, defined_path):
        if not self.car_plan.fetch_map_data():
            print("Failed to fetch map 1 data.") 
        try:
        ...
        try:   
            self.car_plan.defined_visited = set(defined_path)
    ...
    def update_path(self):
        ...
        self.get_path_direction(self.path)
