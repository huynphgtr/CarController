...
# TARGET_URL = "http://127.0.0.1:5500/One_Controller/map_v2.1.0_250812.json"
...
class Controller:
    ...
    def get_priority(self, start0 ): 
        ...
        #     return 'A'
        # elif(start0 == self.start0) and (dest0 == self.dest1): 
        #     self.controllerA.original_start = start0
        #     self.controllerA.original_destination = dest0
        #     self.controllerB.original_start = start1
        #     self.controllerB.original_destination = dest1
        #     return 'A'
        # elif(start0 == self.start1) and (dest0 == self.dest1):
        ...
        #     return 'B'  
        # elif(start0 == self.start1) and (dest0 == self.dest0):
        #     self.controllerB.original_start = start0
        #     self.controllerB.original_destination = dest1
        #     self.controllerA.original_start = start1
        #     self.controllerA.original_destination = dest0
