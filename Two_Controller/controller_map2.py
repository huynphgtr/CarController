...
TOPIC_PUBLISH = "car2/command"
TOPIC_SUBSCRIBE = "car2/status"
SEND_INTERVAL = 10
MOVE_DURATION = 20
STOP_DURATION = 10
...
class controller:
    ...
    async def listener_task(self):
        ...
        while True:
            try:
                ...
                if self.robot_status == 'checkpoint' and self.check_checkpoint():
    ...
    async def send_move_command(self):
        ...
        try:
            ...
            await self.client.publish(self.pub_topic, command.encode('utf-8'), qos=QOS_1)
        except Exception as e:
    ...
    async def automatic_publisher_task(self):
        ...
        try:
            await self.client.publish(self.pub_topic, b'STOP', qos=QOS_1)
        except Exception as e:
